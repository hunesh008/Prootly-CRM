    ...
    <div ref={searchRef} className={`relative ${className}`}>
      <div className="relative">
        <Input
          ...
          className="pl-10 pr-4 py-2 w-80 focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-800 border-slate-300 dark:border-gray-600 text-slate-900 dark:text-slate-100"
        />
